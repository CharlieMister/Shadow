...
annotation class DynamicFieldTarget(
    /**
    ...
    companion object {
        ...
        val RESOLVER: TargetResolver = object : TargetResolver {
            override fun lookupField(
                ...
                val annotation = shadowMethod.getAnnotation(DynamicFieldTarget::class.java)
                ...
                return Optional.of(function.computeField(shadowMethod, shadowClass, targetClass))
            }
        }
    }
}
